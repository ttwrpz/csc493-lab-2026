...
echo
echo ">>> Capturing ICMP on $IFACE (tcpdump, 6s) while we send the spoofed request..."
...
echo
echo "Proof: tcpdump shows  echo request $SPOOF > $TARGET  AND  echo reply $TARGET > $SPOOF"
echo "=================================================="
echo " Task 1.2 done.     Weekly code: $WK"
echo "=================================================="
echo "$WK"
